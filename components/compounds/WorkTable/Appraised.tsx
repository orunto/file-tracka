                ...
                <table className="w-max flex flex-col h-max">
                    ...
                    {props.content.map((clone, i) => (
                        <tr key={i} className="flex rounded-lg border border-gray-200">
                            ...
                            {
                                clone.dateAppraised && (
                                    <td className="flex px-8 py-4 justify-start w-32 text-black text-base font-semibold"><span className="overflow-ellipsis w-full whitespace-nowrap overflow-hidden">{clone.dateAppraised.substring(0, 10)}</span></td>

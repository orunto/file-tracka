...
import Table from "@/components/compounds/WorkTable/DBRecommended"
...
import Queue from "@/components/compounds/WorkTable/PS"
            ...
            return (
                <main className='box-border flex w-screen h-screen overflow-hidden relative'>
                    ...
                    <section className='box-border flex flex-col w-full gap-16 relative h-full overflow-x-hidden'>
                        <Header user_role={`Beta Tester`} username={user.name} page={`Permanent Secretary`} notification={notifications} />
